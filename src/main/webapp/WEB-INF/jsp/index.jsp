            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                        ...
                        <a href="${pageContext.request.contextPath}/races" class="mt-4 block text-sm font-medium text-emerald-600 hover:text-emerald-500">Voir les races &rarr;</a>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                        ...
                        <a href="${pageContext.request.contextPath}/etangs" class="mt-4 block text-sm font-medium text-emerald-600 hover:text-emerald-500">Voir les étangs &rarr;</a>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm font-medium text-gray-500">Nourritures</p>
                                <p class="text-2xl font-semibold text-gray-900">Stocks</p>
                            </div>
                        </div>
                        <a href="${pageContext.request.contextPath}/nourritures" class="mt-4 block text-sm font-medium text-emerald-600 hover:text-emerald-500">Gérer le stock &rarr;</a>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <a href="${pageContext.request.contextPath}/races/new" class="flex items-center p-4 rounded-md border border-gray-200 hover:bg-gray-50 transition">
                            <div class="p-2 rounded bg-emerald-50 text-emerald-600 mr-4">
                        ...
                        <a href="${pageContext.request.contextPath}/etangs/new" class="flex items-center p-4 rounded-md border border-gray-200 hover:bg-gray-50 transition">
                        ...
                        <a href="${pageContext.request.contextPath}/poissons/new" class="flex items-center p-4 rounded-md border border-gray-200 hover:bg-gray-50 transition">
                            <div class="p-2 rounded bg-blue-50 text-blue-600 mr-4">
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                </svg>
                            </div>
                            <span class="text-sm font-medium text-gray-700">Ajouter un nouveau poisson</span>
                        </a>

                        <a href="${pageContext.request.contextPath}/nourritures/new" class="flex items-center p-4 rounded-md border border-gray-200 hover:bg-gray-50 transition">
                            <div class="p-2 rounded bg-amber-50 text-amber-600 mr-4">
                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                                </svg>
                            </div>
                            <span class="text-sm font-medium text-gray-700">Ajouter une nourriture</span>
                        </a>
                    </div>
                </div>
            </div>
