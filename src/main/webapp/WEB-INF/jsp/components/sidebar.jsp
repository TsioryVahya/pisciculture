...
<div class="fixed inset-y-0 left-0 w-64 bg-gray-50 border-r border-gray-200 overflow-y-auto lg:block hidden">
    ...
    <nav class="mt-6 px-4">
        <div class="space-y-1">
            <a href="${pageContext.request.contextPath}/" class="flex items-center px-4 py-2 text-sm font-medium ${uri == pageContext.request.contextPath or uri == (pageContext.request.contextPath.concat('/')) ? 'text-gray-900 bg-gray-200' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'} rounded-md group">
            ...
            <a href="${pageContext.request.contextPath}/races" class="flex items-center px-4 py-2 text-sm font-medium ${fn:contains(uri, '/races') ? 'text-gray-900 bg-gray-200' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'} rounded-md group">
            ...
            <a href="${pageContext.request.contextPath}/etangs" class="flex items-center px-4 py-2 text-sm font-medium ${fn:contains(uri, '/etangs') ? 'text-gray-900 bg-gray-200' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'} rounded-md group">
            ...
            <a href="${pageContext.request.contextPath}/nourritures" class="flex items-center px-4 py-2 text-sm font-medium ${fn:contains(uri, '/nourritures') ? 'text-gray-900 bg-gray-200' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'} rounded-md group">
            ...
            <a href="${pageContext.request.contextPath}/poissons" class="flex items-center px-4 py-2 text-sm font-medium ${fn:contains(uri, '/poissons') ? 'text-gray-900 bg-gray-200' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'} rounded-md group">
            ...
            <a href="${pageContext.request.contextPath}/affectations" class="flex items-center px-4 py-2 text-sm font-medium ${fn:contains(uri, '/affectations') ? 'text-gray-900 bg-gray-200' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'} rounded-md group">
            ...
            <a href="${pageContext.request.contextPath}/alimentations" class="flex items-center px-4 py-2 text-sm font-medium ${fn:contains(uri, '/alimentations') ? 'text-gray-900 bg-gray-200' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'} rounded-md group">
