...
<div class="fixed inset-y-0 left-0 w-64 bg-gray-50 border-r border-gray-200 overflow-y-auto lg:block hidden">
    ...
    <nav class="mt-6 px-4">
        <div class="space-y-1">
            ...
            <!-- Nutriments -->
            <a href="${pageContext.request.contextPath}/nutriments" 
               class="flex items-center px-4 py-2 text-sm font-medium ${fn:contains(uri, '/nutriments') ? 'text-gray-900 bg-gray-200' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100'} rounded-md group">
                <svg class="mr-3 h-6 w-6 ${fn:contains(uri, '/nutriments') ? 'text-gray-500' : 'text-gray-400 group-hover:text-gray-500'}" fill="none" viewBox="0 0 24 24" stroke="currentColor">
